...
def load_saved_artifacts():
    ...
    global __model
    if __model is None:
        with open('/Users/apple/face recog model/server/artifacts/saved_model_.pkl', 'rb') as f:
...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    ...
    eye_cascade = cv2.CascadeClassifier('/Users/apple/face recog model/model/opencv/haarcascades/haarcascade_eye.xml')
...
if __name__ == '__main__':
    ...
    # print(classify_image(None, "./test_images/sharapova1.jpg"))Fucked up